    ...
    tabItem(tabName = "Vis",
          ...
          #    verbatimTextOutput("message"),
              ...
              conditionalPanel("input.options_vis==true",
                               column(width=4,
                                      textInput("vis_title", label="标题选项", placeholder="主标题"),
                                      textInput("vis_subtitle", label=NULL, placeholder="副标题"),
                                      textInput("vis_xlab", label=NULL, placeholder="x-轴标签"),
                                      textInput("vis_ylab", label=NULL, placeholder="y-轴标签"),

                                      checkboxInput("show_legend_options", "图例选项：", value=FALSE),
                                      conditionalPanel("input.show_legend_options==true",
                                                       checkboxInput("vis_show_legend", "显示图例", value=TRUE),
                                                       textInput("vis_color_title", label=NULL, placeholder="色彩图例标题"),
                                                       textInput("vis_fill_title",  label=NULL, placeholder="填充图例标题"),
                                                       textInput("vis_char_size_title",  label=NULL, placeholder="符号大小图例标题"),
                                                       ),
                               ...
                               column(width=4,
                                      ...
                                      conditionalPanel("input.vis_tab == 'Vis2'",
                                                       conditionalPanel("input.vis2_plot_type == 'scatter_t'",
                                                                        selectInput("vis2_scatter_margin_type",
                                                                                    label="添加边缘图：",
                                                                                    choices=scatter_margin,
                                                                                    selected="none"),
                                                                        conditionalPanel("input.vis2_scatter_margin_type != 'none'",
                                                                                         selectInput("vis2_scatter_margins",
                                                                                                     label="选择边缘：",
                                                                                                     choices=c("x轴和y轴"="both", "x轴"="x", "y轴"="y"),
                                                                                                     selected="both")),
                                                                        checkboxInput("vis2_add_rug", "添加地毯", value=FALSE)
                                                       ),

                                                       conditionalPanel("input.vis2_plot_type == 'smooth_scatter_t' | input.vis2_plot_type == 'density2d_t'",
                                                                        checkboxInput("vis2_add_scatter", "添加散点", value=TRUE)),

                                                       conditionalPanel("input.vis2_plot_type == 'smooth_scatter_t'",
                                                                        checkboxInput("vis2_user_palette", "自定义调色板", value=TRUE),
                                                                        conditionalPanel("input.vis2_user_palette == true",
                                                                                         selectInput("vis2_user_palette_low", "选择低阶色彩：",
                                                                                                     choices=colors(), selected="white"),
                                                                                         selectInput("vis2_user_palette_high", "选择高阶色彩：",
                                                                                                     choices=colors(), selected="dodgerblue4")
                                                                        )

                                                       ),

                                                       conditionalPanel("input.vis2_plot_type == 'density_t' | input.vis2_plot_type == 'barplot_t'",
                                                                        selectInput("vis2_position", "选择位置：",
                                                                                    choices=c("堆砌"="stack", "分组"="dodge", "百分比堆砌"="fill"), selected="stack")
                                                       ),

                                                       conditionalPanel("input.vis2_plot_type == 'boxplot_t' | input.vis2_plot_type == 'violin_t' | input.vis2_plot_type == 'barplot_t'",
                                                                        numericInput("vis2_width", label="箱宽", min=0, max=1, value=.7, step=.1),
                                                                        checkboxInput("vis2_horizontal", "水平方向", value=FALSE)
                                                                        ),

                                                       conditionalPanel("input.vis2_plot_type == 'boxplot_t' | input.vis2_plot_type == 'violin_t'",
                                                                        checkboxInput("vis2_box_fill", "填充不同颜色", value=FALSE),
                                                                        checkboxInput("vis2_add_jitter", "添加抖动散点", value=FALSE),
                                                                        conditionalPanel("input.vis2_add_jitter == true",
                                                                                         numericInput("vis2_jitter_width", label="抖动散点范围",
                                                                                                      min=.05, max=.5, value=.3, step=.05)
                                                                        )
                                                       ),
                                                       conditionalPanel("input.vis2_plot_type == 'boxplot_t'",
                                                                        checkboxInput("vis2_notch", "缺口", value=FALSE)
                                                       ),

                                                       conditionalPanel("input.vis2_plot_type == 'violin_t'",
                                                                        checkboxInput("vis2_add_boxplot", "添加箱线图", value=FALSE)
                                                       ),
                                      )
                               )
              )
  ...
  div(
    ...
    conditionalPanel("input.sidebar == 'Vis'",
                     ...
                     conditionalPanel("input.show_palette == true",
                                      ...
                                      selectInput("vis_palette_family_c", label="调色板族(连续)", choices=palette_family_c, selected="base"),
