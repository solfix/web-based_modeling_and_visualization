...
# (1) 标题
header <- dashboardHeader(title = "Dashboard布局")
...
sidebar <- dashboardSidebar(
  ...
  div(
    sidebarMenu(id = "sidebar",
                menuItem("数据", tabName = "Data", selected = TRUE),
                menuItem("单变量可视化", tabName = "Vis1")
    )
  ),
...
body <- dashboardBody(
  ...
  # shinyDashboardThemes共有7种主题：
  #
  # - blue_gradient。展示了渐变、阴影和圆角的使用。
  # - flat_red: 带有红色亮点的平面色彩主题。
  # - gray_light: 轻量级的灰色主题。
  # - gray_dark: 展示了倒置的深色方案的使用。
  # - onenote: 风格类似于OneNote应用程序。
  # - poor_mans_flatly: Flatly主题的穷人版。
  # - purple_gradient: 展示了深色渐变和圆角的使用。
